    ...
    $.fn.extend({
        fshare: function (options) {
            ...
            return this.each(function () {
                ...
                var mediaSource = ["https://www.facebook.com/APEM.NACIONAL?fref=ts",
                                   "https://twitter.com/APEMNACIONAL",
                                   "http://www.pinterest.com/apemnacional7/",
                    ...
                    switch (type) {
                        case 'facebook':
                            if (settings.theme == 'large') {
                                btn = $('<a/>').attr('href', '' + getShareUrl(type, 0) + '').attr('target', '_blank').addClass('social-label').append($('<div/>').addClass('fshare-box-inner').append($('<div/>').addClass('fshare-box').addClass('fshare-button fb').append('<span class="social-count">' + getCount('facebook') + '</span><span class="social-label"></span>')));
                            }
                        ...
                        case 'twitter':
                            if (settings.theme == 'large') {
                                btn = $('<a/>').attr('href', '' + getShareUrl(type, 1) + '').attr('target', '_blank').addClass('social-label').append($('<div/>').addClass('fshare-box-inner').append($('<div/>').addClass('fshare-box').addClass('fshare-button tw').append('<span class="social-count">' + getCount('twitter') + '</span><span class="social-label"></span>')));
                            }
                            else if (settings.theme == 'wide') {
                        ...
                        case 'googleplus':
                            if (settings.theme == 'large') {
                                btn = $('<a/>').attr('href', '' + getShareUrl(type, 2) + '').attr('target', '_blank').addClass('social-label').append($('<div/>').addClass('fshare-box-inner').append($('<div/>').addClass('fshare-box').addClass('fshare-button gplus').append('<span class="social-count">' + getCount('googleplus') + '</span><span class="social-label"></span>')));
                            }
                            else if (settings.theme == 'wide') {
